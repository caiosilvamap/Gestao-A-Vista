...
const Header = (props: {
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow gap-3 items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11">
        ...
        {!props.sidebarOpen && (
          <Link className="block " to="/">
            <IconSVG src="/src/images/logo/logo-GTA-preto.svg" width={168} height={50} className="dark:invert"/>
          </Link>
        )}


        <Link className="flex-grow flex items-center justify-center" to="/">
          <h1 className="uppercase text-title-lg text-sm font-semibold text-dark" >
            Gestão à vista
          </h1>
        </Link>
        ...
        <div className="flex items-center gap-3 2xsm:gap-7">
          <ul className="flex ml-3 items-center gap-2 2xsm:gap-4">
            {/* <!-- Dark Mode Toggler --> */}
            <DarkModeSwitcher />
            {/* <!-- Dark Mode Toggler --> */}
